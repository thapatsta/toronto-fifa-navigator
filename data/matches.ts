...
export const matches: Match[] = [
  {
    ...
    time: "3:00 PM ET",
    homeTeam: "Canada",
    awayTeam: "European Playoff A Winner",
    awayShort: "Euro Playoff A",
    homeFlag: "🇨🇦",
    awayFlag: "🏴",
    stage: "Group Stage",
    group: "Group F",
    ...
    notes: "Canada's first-ever home FIFA World Cup match. Opponent confirmed from UEFA Playoff Path A (Bosnia & Herzegovina vs Italy final, March 31 2026) — update awayTeam and awayFlag once result is confirmed.",
  },
  {
    id: "match-2",
    date: "2026-06-17",
  ...
  },
  {
    ...
    time: "3:00 PM ET",
    homeTeam: "Senegal",
    awayTeam: "FIFA Intercontinental Playoff Winner",
    awayShort: "Intercont. Playoff",
    homeFlag: "🇸🇳",
    awayFlag: "🏴",
    stage: "Group Stage",
    group: "Group I",
    ...
    notes: "Opponent confirmed from FIFA Intercontinental Playoff (Bolivia vs Iraq final, March 31 2026) — update awayTeam and awayFlag once result is confirmed.",
  },
  {
    id: "match-6",
    date: "2026-07-02",
